...
{{--            @endif--}}
            ...
            <section class="hero">
                ...
                <button class="call-to-action">See My Work</button>
            </section>
            ...
            <section class="testimonials">
                ...
                axe the slideshow. Maybe a quote from "... Great to Work with ..." -- Steven Records
            </section>
            ...
            <section class="work-sample">
                Image with link next to a brief explanation
